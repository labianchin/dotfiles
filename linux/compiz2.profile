...
[core]
as_active_plugins = core;ccp;move;resize;place;decoration;png;resizeinfo;grid;workarounds;imgjpeg;dbus;put;svg;video;vpswitch;text;session;mousepoll;wallpaper;regex;gnomecompat;commands;snap;ring;wall;animation;fade;expo;scale;switcher;scalefilter;scaleaddon;bench;
